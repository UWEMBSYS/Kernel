...
{
typedef struct {
    uint32_t        Lock;       //!< The container for the thread ID that owns the lock. 
    uint32_t        Count;      //!< The numebr of lock this thread has requested. Unlock when this reaches zero.
